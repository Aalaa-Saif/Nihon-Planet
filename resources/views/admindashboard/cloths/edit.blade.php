    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card bg-dark text-light px-2">
                ...
                <div class="card-body">
                    <form method="POST" action="" id="clothUpdateid" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="name_ar" value="{{ $cloth_edit->name_ar }}" autofocus>
                                    <small id="name_ar_error" class="small-text text-danger font-weight-bold" role="alert"></small>
                            </div>
                        </div>
                        <input type="text" class="form-control" name="id" style="display:none;" value="{{ $cloth_edit->id }}">
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-md-center">Info in Arabic</label>

                            <div class="col-md-7">
                                <textarea class="form-control" name="info_ar" rows="3">{{ $cloth_edit->info_ar }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" name="name_en" value={{ $cloth_edit->name_en }} autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea class="form-control" name="info_en" rows="3">{{ $cloth_edit->info_en }}</textarea>
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label text-md-center">Photo</label>
                                ...
                                <img class="img-fluid ml-3" style="width:100px; height:100px" src="{{asset('img/cloths/'.$cloth_edit->photo)}}">
                        ...
                        <div class="row">
                            <div class="col-md-3 offset-md-3">
                                <button id="clothUpdatebtn" class="btn btn-primary">
                                    Update
                                </button>
                            </div>
                        </div>
...
@section('script')
    <script>
        $(document).on('click','#clothUpdatebtn',function(e){
            e.preventDefault();

            var formData = new FormData($('#clothUpdateid')[0]);
            $.ajax({
                method:"post",
